...
var PageHeader = function (_Component) {
  ...
  _createClass(PageHeader, [{
    ...
    value: function render() {
      ...
      var superTitle = _props.superTitle;
      ...
      var styles = {
        ...
        superTitle: _extends({}, (0, _typography.heading)(theme, 1), {
          color: theme.pageHeadingTextColor,
          opacity: 0.6,
          margin: 0
        }),
        title: _extends({}, (0, _typography.heading)(theme, 4), {
          color: theme.pageHeadingTextColor,
          margin: 0
        })
      };
...
PageHeader.propTypes = {
  ...
  superTitle: _react.PropTypes.string.isRequired
};
